...
class PayQuotation extends StatefulWidget {
  OrderModel orderModel;
  PayQuotation({@required this.orderModel});

  @override
  _PayQuotationState createState() => _PayQuotationState();
}

class _PayQuotationState extends State<PayQuotation> {
  double height;
  double width;
  var total = 0.0;
  bool loading = false;
      ...
      bottomNavigationBar: BottomAppBar(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text("Total Price:  RWF" + total.toString()),
              Container(
                width: width,
                height: 43.0,
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            SlideRightRoute(
                              page: ComparisonScreen(
                                product: items[index].item,
                              ),
                            ));
                      },
                      child: Card(
                          ...
                          title: Row(
                            ...
                            children: <Widget>[
                              Text(
                                ...
                                style: TextStyle(
                                    color: smarthireDark, fontSize: 18.0),
                              ),
                              Icon(
