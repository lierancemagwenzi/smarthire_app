...
class CompleteOrderController extends ControllerMVC {
...
bool success=false;
  ...
  void  Completeorder(BuildContext context) {
    ...
    completeorder(orderModel.id).then((value) {
      print(value);
      setState(() {
        loading=false;
        if(value!=null){
          this.orderModel=value;
          Toast.show("Order completed successfully", context, duration: Toast.LENGTH_LONG, gravity:  Toast.CENTER);
