...
import 'package:smarthire/src/pages/Department.dart';
import 'package:smarthire/src/repository/settings_repository.dart';

DepartmentsWidget(double height,List<Department> categories){
          ...
          return InkWell(
            onTap: (){
              Navigator.push(
                  context,
                  CupertinoPageRoute(
                      builder: (context) => DepartmentWidget(
                        department: categories[index],
                      )));
            },
            child: Padding(
