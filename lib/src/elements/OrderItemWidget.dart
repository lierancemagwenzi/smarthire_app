...
class OrderItemWidget extends StatefulWidget {
  ...
  OrderItemWidget({Key key, this.expanded, this.order, this.onCanceled,this.context,this.controller,this.index}) : super(key: key);
                          ...
                          children: List.generate(
                            widget.order.order_products.length,
                              ...
                              return ProductOrderItemWidget(
                                  heroTag: 'my_order6698', order: widget.order, productOrder: widget.order.order_products.elementAt(indexProduct));
                            },
                    ...
                    FlatButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                            CupertinoPageRoute(
                                builder: (context) => TrackingWidget(orderModel: widget.order,context: widget.context,controller: widget.controller,index:widget.index)));
                      },
