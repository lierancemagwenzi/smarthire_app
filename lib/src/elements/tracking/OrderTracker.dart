...
Widget OrderTracker(OrderModel orderModel,BuildContext context){
  ...
  return Padding(
    ...
    title: Text(
        ...
        style: appcolor.value.headerStyle.copyWith(color: appcolor.value.darkcolor,)),
          ...
          subtitle: Text(orderModel.orderStatus.client_explanation??'',style: appcolor.value.bodyStyle.copyWith(color: appcolor.value.darkcolor,)),
          ),
        ),
...
trailing: orderModel.orderStatus.canchat?Icon(Icons.chat_bubble_outline):null,
          title: Text("Provider",style: appcolor.value.headerStyle.copyWith(color: appcolor.value.darkcolor,)),

          subtitle:Text(orderModel.sellerAccount.name,style: appcolor.value.bodyStyle.copyWith(color: appcolor.value.darkcolor,)),
        ...
        orderModel.picked_time!=null? ListTile(
          ...
          title: Text("Picked Time",style: appcolor.value.headerStyle.copyWith(color: appcolor.value.darkcolor,)),
...
title: Text("Service requested Date"),
         subtitle:               Text("Your requested date for service delivery is "+(orderModel.requested_date??' '),style: appcolor.value.bodyStyle.copyWith(color: appcolor.value.darkcolor,)),
